...
public class Lesson5_6 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = "Lesson5_6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, TAG + " view status is " + db.getLesson(506).getViewed());
        db.updateLesson(new DBLesson(506, 1));
        Log.e(TAG, TAG + " view status is " + db.getLesson(506).getViewed());
        ...
        setContentView(R.layout.activity_lesson5_6);
        ...
        TextView textView = findViewById(R.id.lesson5_6TextView);
        textView.setTextColor(Color.parseColor("#FF9933"));
        textView.setTypeface(textView.getTypeface(), Typeface.BOLD);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,30);
        final ListView listView = findViewById(R.id.lesson5_6ListView);
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://en.wikipedia.org/w/api.php?action=query&format=json&prop=extracts&titles=Telnet&exlimit=1";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        response = response.substring(0, 8680);
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Lesson5_6.this,android.R.layout.simple_list_item_1,content){
                            @Override
