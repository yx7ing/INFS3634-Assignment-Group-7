...
public class Lesson4_1 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = "Lesson4_1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, TAG + " view status is " + db.getLesson(401).getViewed());
        db.updateLesson(new DBLesson(401, 1));
        Log.e(TAG, TAG + " view status is " + db.getLesson(401).getViewed());
        ...
        TextView textView = findViewById(R.id.lesson4_1TextView);
        textView.setTextColor(Color.parseColor("#FF9933"));
        textView.setTypeface(textView.getTypeface(), Typeface.BOLD);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,30);
        final ListView listView = findViewById(R.id.lesson4_1ListView);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Lesson4_1.this,android.R.layout.simple_list_item_1,content){
                            @Override
