...
public class Lesson4_5 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = "Lesson4_5";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, TAG + " view status is " + db.getLesson(405).getViewed());
        db.updateLesson(new DBLesson(405, 1));
        Log.e(TAG, TAG + " view status is " + db.getLesson(405).getViewed());
        ...
        TextView textView = findViewById(R.id.lesson4_5TextView);
        textView.setTextColor(Color.parseColor("#FF9933"));
        textView.setTypeface(textView.getTypeface(), Typeface.BOLD);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,30);
        final ListView listView = findViewById(R.id.lesson4_5ListView);
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://en.wikipedia.org/w/api.php?action=query&format=json&prop=extracts&titles=Distance-vector_routing_protocol&exlimit=1";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        response = response.substring(0, 8357);
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Lesson4_5.this,android.R.layout.simple_list_item_1,content){
                            @Override
