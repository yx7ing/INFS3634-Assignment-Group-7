...
public class Lesson4_7 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = "Lesson4_7";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, TAG + " view status is " + db.getLesson(407).getViewed());
        db.updateLesson(new DBLesson(407, 1));
        Log.e(TAG, TAG + " view status is " + db.getLesson(407).getViewed());
        ...
        setContentView(R.layout.activity_lesson4_7);
        ...
        TextView textView = findViewById(R.id.lesson4_7TextView);
        textView.setTextColor(Color.parseColor("#FF9933"));
        textView.setTypeface(textView.getTypeface(), Typeface.BOLD);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,30);
        final ListView listView = findViewById(R.id.lesson4_7ListView);
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://en.wikipedia.org/w/api.php?action=query&format=json&prop=extracts&titles=Routing_Information_Protocol&exlimit=1";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        response = response.substring(0, 12371);
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Lesson4_7.this,android.R.layout.simple_list_item_1,content){
                            @Override
