...
public class Quiz4 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = findViewById(R.id.quiz4TextView);
        ...
        qna[0] = "Question " + questionNum[0] + ". " + db.getQuestion(questionNum[0]+36).getQuestion() + "\n";
        qna[1] = db.getQuestion(questionNum[0]+36).getAnswera() + "\n";
        qna[2] = db.getQuestion(questionNum[0]+36).getAnswerb() + "\n";
        qna[3] = db.getQuestion(questionNum[0]+36).getAnswerc() + "\n";
        qna[4] = db.getQuestion(questionNum[0]+36).getAnswerd() + "\n";
        final int[] answers = new int[12];
        ListView listView = (ListView) findViewById(R.id.quiz4ListView);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) {
                    ...
                    if (questionNum[0] < 12) {
                        ...
                        Intent i = new Intent(Quiz4.this, Quiz4Complete.class);
