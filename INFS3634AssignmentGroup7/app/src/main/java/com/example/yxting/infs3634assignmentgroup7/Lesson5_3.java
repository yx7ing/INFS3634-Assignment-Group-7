...
public class Lesson5_3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = "Lesson5_3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, TAG + " view status is " + db.getLesson(503).getViewed());
        db.updateLesson(new DBLesson(503, 1));
        Log.e(TAG, TAG + " view status is " + db.getLesson(503).getViewed());
        ...
        TextView textView = findViewById(R.id.lesson5_3TextView);
        textView.setTextColor(Color.parseColor("#FF9933"));
        textView.setTypeface(textView.getTypeface(), Typeface.BOLD);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,30);
        final ListView listView = findViewById(R.id.lesson5_3ListView);
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = "https://en.wikipedia.org/w/api.php?action=query&format=json&prop=extracts&titles=User_Datagram_Protocol&exlimit=1";
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        response = response.substring(0, 15593);
                        ...
                        content.remove(19);
                        content.remove(23);
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Lesson5_3.this,android.R.layout.simple_list_item_1,content){
                            @Override
